...
export default function PatientApp() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {emergencySent && (
        <div className="bg-green-500 text-white px-4 py-3 text-center font-semibold animate-pulse fixed top-0 left-0 right-0 z-[100]">
      ...
      {/* Error Banner */}
      {error && (
        <div className="bg-yellow-50 border-b border-yellow-200 px-4 py-3 fixed top-0 left-0 right-0 z-[100]">
          <div className="flex items-center gap-2 text-yellow-800 max-w-lg mx-auto">
